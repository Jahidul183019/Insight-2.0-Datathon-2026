...
Weighted F1 at fixed 84.5%: `0.877004`. Gap versus Submission 6 public LB `0.877258`: `-0.000254` (close under the predeclared ±0.005 sanity band).
...
- Completed outer folds: [1, 2, 3, 4, 5].
- Mean pseudo-label count across completed folds: 17469.4.
